                        ...
                        <div class="property-card">
                                    ...
                                    <div class="swiper-wrapper">
                                        @if ($bestDeal->images && count($bestDeal->images))
                                            @foreach ($bestDeal->images as $img)
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('storage/' . $img->url) }}"
                                                        class="w-full h-full object-cover" alt="{{ $bestDeal->title }}">
                                                </div>
                                            @endforeach
                                        @else
                                            {{-- Default fallback image --}}
                                ...
                                <div class="absolute top-3 left-3">
                                    <span class="bg-blue-600 text-white text-xs font-medium px-2 py-1 rounded">
                                        ...
                                        {{ $type === 'RENT'
                                            ...
                                            : ($type === 'SALE'
                                                ? __('index.best_deals.sale')
                                                : strtoupper($bestDeal->type)) }}
                                    </span>
                                </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-start text-sm text-gray-600 mt-4 gap-4">
                                    ...
                                    @php
                                        $isLand =
                                            $bestDeal->propertyTypes?->contains(fn($t) => $t->slug === 'land') ?? false;
                                    @endphp

                                    @if (!$isLand)
                                        <div class="flex items-center">
                                            <i class="fas fa-bed text-gray-400 mr-1"></i>
                                            <span>{{ $bestDeal->bedrooms ?? '-' }}
                                                {{ __('index.best_deals.beds') }}</span>
                                        </div>

                                        <div class="flex items-center">
                                            <i class="fas fa-bath text-gray-400 mr-1"></i>
                                            <span>{{ $bestDeal->bathrooms ?? '-' }}
                                                {{ __('index.best_deals.baths') }}</span>
                                        </div>
                                    @endif
                                    ...
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            @if ($bestDeal->listedBy->profile_image)
                                                <img src="{{ asset('storage/' . $bestDeal->listedBy->profile_image) }}"
                                                    alt="" class="rounded-2xl w-full h-full">
                                            @else
                                                {{ strtoupper(substr($bestDeal->listedBy->name, 0, 2)) }}
                                            @endif
                                        </div>
...
<section class="w-full max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="swiper villa-multiple-slide-carousel w-full relative fade-in p-4 h-100">
        <div class="swiper-wrapper">
                        ...
                        <a href="{{ route('detail', ['property' => $villa->id]) }}">
                            <div class="property-card">
                                <div class="relative">
                                    ...
                                    <div class="absolute top-3 left-3">
                                        <span
                                            class="{{ $badgeColor }} text-white text-xs font-medium px-2 py-1 rounded">
                                ...
                                <div class="p-4">
                                    ...
                                    @php
                                        $isLand =
                                            $villa->propertyTypes?->contains(
                                                fn($t) => strtolower((string) $t->slug) === 'land',
                                            ) ?? false;
                                    @endphp
                                    ...
                                    <div class="flex gap-4 text-sm text-gray-600 mt-4">
                                        @if (!$isLand)
                                            <span><i
                                                    class="fas fa-bed text-gray-400 mr-1"></i>{{ $villa->bedrooms ?? '-' }}
                                                {{ __('index.villas.labels.beds') }}</span>
                                            <span><i
                                                    class="fas fa-bath text-gray-400 mr-1"></i>{{ $villa->bathrooms ?? '-' }}
                                                {{ __('index.villas.labels.baths') }}</span>
                                        @endif

                                        <span><i
                                                class="fas fa-vector-square text-gray-400 mr-1"></i>{{ $villa->area ?? '-' }}
                                            {{ __('index.villas.labels.sqft') }}</span>
                                    </div>
