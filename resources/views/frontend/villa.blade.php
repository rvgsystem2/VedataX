    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden xl:flex items-center space-x-6">
                ...
                <!-- Buy / Rent -->
                <a href="{{ route('property') }}" class=" bg-black text-white hover:text-gray-50 transition flex items-center p-3 rounded-xl">
                ...
                <form class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        ...
                        <select
                            class="bg-white/40 border border-black/20 rounded-2xl text-sm text-black pl-12 md:pr-8 py-3 focus:ring-2 focus:ring-blue-400 hover:bg-white/60 transition cursor-pointer">
