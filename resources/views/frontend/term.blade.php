...
@section('content')
  ...
  <main class="max-w-5xl mx-auto p-6">
    ...
    <!-- Section 1 -->
    <section class="mb-8">
      <h3 class="text-2xl font-semibold gold mb-2 font-spartan">    1. Services Provided</h3>
    ...
    <!-- Section 2 -->
    <section class="mb-8">
      <h3 class="text-2xl font-semibold gold mb-2 font-spartan">  2. Using the Website</h3>
    ...
    <!-- Section 3 -->
    <section class="mb-8">
      <h3 class="text-2xl font-semibold gold mb-2 font-spartan">   3. Privacy</h3>
      <p class="text-gray-800 mb-2 font-spartan">
    ...
    <!-- Section 4 -->
    <section class="mb-8">
      <h3 class="text-2xl font-semibold gold mb-2 font-spartan">4. Changes to These Terms</h3>
      <p class="text-gray-800 font-spartan" >
    ...
    <!-- Section 5 -->
    <section class="mb-8">
      <h3 class="text-2xl font-semibold gold mb-2 font-spartan"> 5. Intellectual Property</h3>
      <p class="text-gray-800 font-spartan">
    ...
    <!-- Section 6 -->
    <section class="mb-8">
      <h3 class="text-2xl font-semibold gold mb-2 font-spartan"> 6. Links to Third-Party Websites</h3>
      <p class="text-gray-800 font-spartan">
     ...
     <section class="mb-8">
        <h3 class="text-2xl font-semibold gold mb-2 font-spartan"> 7. Limitation of Liability</h3>
        <p class="text-gray-800 font-spartan">
     ...
     <section class="mb-8">
        <h3 class="text-2xl font-semibold gold mb-2 font-spartan">   8. Governing Law</h3>
        <p class="text-gray-800 font-spartan">
     ...
     <section class="mb-8">
        <h3 class="text-2xl font-semibold gold mb-2 font-spartan">9. Contact Information</h3>
        <p class="text-gray-800 font-spartan">
            For any questions about this Privacy Policy or your personal information, please contact:
            </p>
            <span><strong>Email:</strong>  info@vedata.co</span>
            <br>
            <span><strong>Phone:</strong>  +66 96 662 6272</span>
     </section>
  </main>
